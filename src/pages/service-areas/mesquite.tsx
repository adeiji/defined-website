                    ...
                    <div className="content-container">
                        ...
                        <Row className="my-5">
                            <Col xs={12}>
                                ...
                                <hr />
                                <p>
                                    {city} presents unique challenges for window cleaning. Located in the Virgin Valley with intense desert heat, high winds, and seasonal dust storms, properties here require specialized maintenance. At Defined Cleaning, we've developed custom solutions specifically designed for Mesquite's distinctive environment.
                                </p>
                                ...
                                <div className="numbered-list-container my-4">
                                    ...
                                    <ul className="numbered-list">
                                        ...
                                        <li><strong>Golf Community Homes:</strong> Special care for properties on golf courses with additional maintenance needs</li>
                                        <li><strong>Extreme Heat:</strong> Specialized cleaning solutions that work effectively even in high temperatures</li>
                                    </ul>
                                </div>
                            </Col>
                        </Row>
                        ...
                        <Row className="my-5">
                            <Col xs={12} md={6}>
                                ...
                                <div className="numbered-list-container">
                                    <ul className="numbered-list">
                                        <li>Sun City Mesquite</li>
                                        <li>Mesquite Vistas</li>
                                        <li>Pulte Homes</li>
                                        ...
                                        <li>Rancho Mesa</li>
                                        <li>Desert Skies</li>
                                        <li>Mesquite Springs</li>
                                        <li>All other Mesquite neighborhoods</li>
                                    </ul>
                                </div>
                            </Col>
                            <Col xs={12} md={6}>
                                <div className="icon-card mt-4">
                                    ...
                                    <div className="icon-content">
                                        ...
                                        <p>
                                            We understand the unique conditions in Mesquite that affect your windows. Our team has experience with the specific challenges faced by homeowners in this area and knows how to address them effectively.
                                        </p>
                                    </div>
                                </div>
                                <div className="icon-card mt-4">
                                    ...
                                    <div className="icon-content">
                                        <h3>Retirement Community Specialists</h3>
                                        <p>
                                            Mesquite is home to many active adult communities. We provide trustworthy, respectful service that residents can count on, with flexible scheduling to accommodate your lifestyle.
                                        </p>
                                    </div>
                                </div>
                            </Col>
                                    ...
                                    <Col md={4} className="mb-4">
                                        <div className="gallery-card h-100">
                                            <div className="p-4">
                                                ...
                                                <p className="mb-4">
                                                    "The solar screens Defined Cleaning installed have made a huge difference in keeping our home cool during Mesquite's hot summers. Professional installation and excellent quality screens."
                                                </p>
                                                <div className="text-right font-italic">
                                                    <strong>- Linda J., Highland Hills</strong>
                                                </div>
                                            </div>
                                        </div>
                                    </Col>
                                    <Col md={4} className="mb-4">
                                        <div className="gallery-card h-100">
                                            <div className="p-4">
                                                ...
                                                <h5 className="mb-3">Worth the Drive</h5>
                                                <p className="mb-4">
                                                    "Even though they come from Las Vegas, Defined Cleaning's service is worth the wait. They cleaned our windows, tracks, and power washed our driveway. Everything looks brand new!"
                                                </p>
                                                <div className="text-right font-italic">
                                                    <strong>- Thomas B., Falcon Ridge</strong>
                                                </div>
                                            </div>
                                        </div>
                                    </Col>
